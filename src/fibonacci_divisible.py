def generate_modified_fibonacci(n):
    """
    Generate a modified Fibonacci sequence up to n numbers where 
    the sum of any two consecutive numbers (from 3rd number onwards) 
    ...
    while len(sequence) < n:
        ...
        # Adjust the next number if needed to make the sum divisible by 3
